...
export default function Dashboard({ onLogout }: DashboardProps) {
  ...
  const navItems = [
    ...
    { id: 'calendar', icon: <Calendar className="w-5 h-5" />, label: 'Calendar', roles: ['admin', 'agency_manager', 'project_manager', 'team_head', 'hr', 'specialist', 'sales_manager'] },
    { id: 'team', icon: <Users className="w-5 h-5" />, label: 'Team', roles: ['admin', 'agency_manager', 'project_manager', 'team_head', 'hr', 'sales_manager'] },
    { id: 'intelligence', icon: <Zap className="w-5 h-5" />, label: 'Team Intelligence', roles: ['admin', 'agency_manager', 'project_manager', 'team_head', 'hr', 'sales_manager'] },
    { id: 'timesheets', icon: <History className="w-5 h-5" />, label: 'Timesheets', roles: ['admin', 'agency_manager', 'project_manager', 'team_head', 'hr'] },
    { id: 'activity', icon: <Clock className="w-5 h-5" />, label: 'Activity Log', roles: ['admin', 'agency_manager', 'project_manager', 'hr', 'sales_manager'] },
    { id: 'workflow', icon: <Network className="w-5 h-5" />, label: 'Workflow', roles: ['admin', 'agency_manager'] },
    { id: 'strategist', icon: <Star className="w-5 h-5" />, label: 'Strategist', roles: ['admin', 'agency_manager', 'project_manager', 'sales_manager', 'team_head', 'specialist', 'hr'] },
