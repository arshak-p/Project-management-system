    ...
    <div className="space-y-10 pb-20 font-inter max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-10">
           {/* Sidebar: Member List - Made Sticky and Self-Starting */}
           <div className="md:col-span-4 lg:col-span-3 space-y-4 md:sticky md:top-24 md:self-start max-h-[40vh] md:max-h-[80vh] overflow-y-auto custom-scrollbar pr-2 order-2 md:order-1">
